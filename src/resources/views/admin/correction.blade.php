...
<div class="apply__list">
    <form action="/stamp_correction_request/approve/{attendance_correct_request}" method="post" class="apply-list__form">
        @csrf
        ...
        <table class="apply-list__table">
            ...
            <tr class="apply-list__table-row">
                ...
                <td class="apply-list__table-date">
                    ...
                    <input type="hidden" name="clock_id" value="{{ $clocks->clock_id }}">
                    <input type="hidden" name="apply_clock_id" value="{{ $clocks->id }}">
                </td>
            </tr>
            <tr class="apply-list__table-row">
                ...
                <td class="apply-list__table-date">
                    <input type="hidden" name="break_time_id" value="{{ $break->break_time_id }}">
                    <input type="hidden" name="apply_break_id" value="{{ $break->id }}">
        ...
        <div class="correction__button">
            <button class="correction__button-submit" type="submit" name="admin">管理者修正</button>
        </div>
    </form>
</div>
